...
export function buildDefaultPrompt(toolType: string, content: string): string {
    ...
    if (toolType === AI_PROMPT_TYPE.TRAN) {
        ...
        prompt += "3. Chỉ phần 3 này nội dung đáp án dữ nguyên tiếng anh không dịch các phần khác vẫn dịch bình thường. Giải thích tất cả các phương án (đúng và sai), nêu rõ vì sao đúng, vì sao sai, nếu có ví dụ minh họa thì càng tốt. (nếu có câu hỏi và đáp án, không có thì bỏ qua)\n";
