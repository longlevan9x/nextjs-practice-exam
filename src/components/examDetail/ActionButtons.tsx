      ...
      <div className="flex space-x-4">
        {!isFirstQuestion && (
          <button
            ...
            className={`flex items-center cursor-pointer px-2 py-1 lg:px-4 lg:py-2 bg-gray-200  text-gray-700   hover:bg-gray-300 dark:text-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 rounded-xs transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-gray-200 ${isBacking ? 'opacity-50 cursor-not-allowed' : ''}`}
          >
            <span>Quay lại</span>
        ...
        {(!selectedAnswer && !showExplanation && !isLastQuestion) && (
          <button
            ...
            className={`flex items-center cursor-pointer px-2 py-1 lg:px-4 lg:py-2 border border-blue-700 rounded-xs hover:bg-gray-200 dark:hover:bg-gray-700 transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-yellow-100 ${checkingAnswer ? 'opacity-50 cursor-not-allowed' : ''}`}
          >
