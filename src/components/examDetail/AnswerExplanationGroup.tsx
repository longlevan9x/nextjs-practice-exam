...
const AnswerExplanationGroup: React.FC<AnswerExplanationGroupProps> = ({ question, isExpanded }) => {
    ...
    return (
        <div className={`mt-6 p-4 bg-gray-50 dark:bg-neutral-800 border border-gray-300 dark:border-gray-600 rounded-xs transition-all duration-300 delay-100 ${isExpanded ? 'translate-y-0 opacity-100' : '-translate-y-4 opacity-0'}`}>
