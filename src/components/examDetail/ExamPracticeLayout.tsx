    ...
    return (
        <div className="text-gray-900 dark:text-gray-300 grid grid-cols-12">
            ...
            <div className="lg:col-span-4 xl:col-span-3 col-span-12">
                <div className=" h-full lg:max-h-[calc(100vh-5rem)] lg:overflow-y-auto z-20 relative bg-white dark:bg-neutral-900">
                    <QuestionList
                        questions={questions}
                        ...
                        {displayMode === DISPLAY_MODES.EXECUTE && (
                            <div className="flex justify-end">
                                <button
                                    ...
                                    className={`cursor-pointer whitespace-pre border-2 border-blue-600 bg-white dark:bg-neutral-900 text-gray-900 dark:text-gray-300 px-2 py-1 lg:px-4 lg:py-2 rounded-xs transition duration-300 flex items-center justify-center ${isFinishing ? 'opacity-50 cursor-not-allowed' : 'hover:bg-blue-700 hover:text-white'}`}
                                >
            ...
            {displayMode === DISPLAY_MODES.EXECUTE && (
                <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-neutral-900 border-t border-gray-200 dark:border-gray-700 z-10">
